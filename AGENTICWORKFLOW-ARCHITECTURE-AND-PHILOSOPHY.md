...
graph TB
    subgraph "AgenticWorkflow 코드베이스 (설계 프레임워크)"
        ...
        subgraph "Context Preservation + Safety"
            CPS["hooks/scripts/<br/>22개 Python 스크립트 + 1 라이브러리 + Setup 2개<br/>(Context Preservation 6 + Safety 3 + P1 Validation 14 + Setup 2<br/>+ Abductive Diagnosis Layer)"]
